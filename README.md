...
[Клиент: Vue.js 3 + TypeScript] --HTTP/REST API + Cookies--> [Сервер: Spring Boot 3]
[Сервер: Spring Boot 3] --JPA/Hibernate--> [PostgreSQL]
[Сервер: Spring Boot 3] --File I/O--> [Файловая система: /upload]
...
Студент курса Java Developer (Netology)
GitHub: https://github.com/esprakta

---
Проект разработан в учебных целях в рамках защиты дипломной работы.
